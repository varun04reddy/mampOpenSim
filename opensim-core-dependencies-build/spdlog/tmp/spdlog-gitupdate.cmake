...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v1.4.1"
  WORKING_DIRECTORY "C:/opensim-core-source/dependencies/spdlog"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/opensim-core-source/dependencies/spdlog'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/opensim-core-source/dependencies/spdlog'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
